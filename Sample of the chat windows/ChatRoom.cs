...
namespace Sample_of_the_chat_windows
{
    ...
    public partial class ChatRoom : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
           ...
           // Net.sendMsg(Program.myself.comm.GetStream(), new Chat_message(str_message, Program.myself.ToString()));
        ...
        private void textBox1_Validated(object sender, EventArgs e)
        {
            ...
            while (true)
                { 
                    ...
                    //this.addText((Chat_message)Net.rcvMsg(Program.myself.comm.GetStream()));
                    Thread.Sleep(500);
                }
                 }).Start();
        }
